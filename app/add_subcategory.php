...
{
     $query="INSERT INTO subcategory(subcategory_title,subcategory_image,category_id) VALUES ('$subCategoryName','$CategoryImage','$category_id')";
                    ...
                    <form id="demo-form2" method="POST"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" >
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="SubCategoryName" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="SubCategoryName" placeholder="Sub Category Name" required="required" type="text">
                        </div>
                      </div>
...
?>        
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <a href="add_subcategory.php"> <button type="button" class="btn btn-primary">Cancel</button></a>
