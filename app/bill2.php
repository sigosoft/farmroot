...
<div class="right_col" role="main">
  ...
  <div class=" conatiner">
      ...
      <div class="col-md-9">
        <div class="row">
         ...
         <div class="row">
          ...
          <div class="col-md-2">
             <input class="form-control" name="BillingDet_time" id="BillingDet_time" placeholder="Billing Time" required="required" type="time" value="time">
          </div>
          <div class="col-md-2">
    ...
    <div class="p-0 col-md-2 col-sm-12 col-xs-12">
      ...
      <input class="form-control" name="Quantity" placeholder="" type="text" id="Quantity" onchange="GetPtotal()">
      </div>


       <div class="p-0 col-md-2 col-sm-12 col-xs-12">
           <label>Total</label>
      <input class="form-control " name="Total" placeholder="" type="text" id="Total" onchange="">
      </div>
