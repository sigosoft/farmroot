  ...
  <div class=" conatiner">
    <div class="row">
      <div class="col-md-9">
        <div class="row">
          <div class="col-md-4">
             <input class="form-control" name="BillingDet_Phone" placeholder="Phone" id="BillingDet_Phone" onchange="GetCustomer()" required="required" type="text">
          </div>
           <div class="col-md-4">
             <input class="BillingDet_Name" name="BillingDet_Name" id="BillingDet_Name" placeholder="Customer Name" required="required" type="text">
          </div>
           <div class="col-md-4">
      ...
      <div class="col-md-3">
       <textarea cols="7" rows="6" id="BillingDet_Address" name="BillingDet_Address" class="form-control"></textarea>
      </div>
    </div>
  </div><br>
    ...
    var ptotale = (ptotal).toFixed(2);
     ...
     document.getElementById('Total').value = ptotale;
       ...
       function Getproduct()
       {
           ...
           document.getElementById('Product_MRP').value =temp.Product.Product_MRP;
...
function insertRow(){
           ...
           else
           {
            ...
            if (list[i].prod_id === Product_Id) {
            
            var test=1;
            var getindex=list[i].proindex;
            break; 
            }
            }
             ...
             if(test==1)
             {
               ...
               var GetMRP = "Product_MRP"+getindex;
               document.getElementById(GetMRP).value=Product_MRP;

               var GetQuantity = "Quantity"+getindex;
               document.getElementById(GetQuantity).value=Quantity;

               var GetTotal = "Total"+getindex;
             ...
             {
                 var proindex=index;
                 list.push({prod_id:Product_Id,proindex:proindex});
