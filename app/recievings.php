  ...
  <div class=" conatiner">
    <div class="row">
      <div class="col-md-9">
        <div class="row">
          <div class="col-md-4">
      <select class="form-control selectpicker" data-live-search="true"  name="VBillingDet_Name" id="VBillingDet_Name" placeholder="Vendor Name" onchange="GetVendors()" required>
...
?>   
      ...
      <div class="col-md-3">
       <textarea cols="7" rows="6" id="VBillingDet_Address" name="VBillingDet_Address" class="form-control" placeholder="Address"></textarea>
      </div>
    </div>
  </div><br>
...
<div class="p-0 col-md-2 col-sm-12 col-xs-12">
      <input class="form-control " name="offer_price" placeholder="Offer Price" type="text" id="offer_price" >
      </div>


    <div class="p-0 col-md-2 col-sm-12 col-xs-12">
      <input class="form-control" name="Quantity" placeholder="Quantity" type="text" id="Quantity" oninput="GetPtotal()">
      </div>
      ...
      <input type="button" class="btn btn-success m-l" name="submit" onclick="insertRow();" value="submit"></td>
       ...
       <div class="conatiner">
          <div class="row">
            <div class="p-0 col-md-2 col-sm-12 col-xs-12 col-md-push-6">
...
<script>
   ...
   <script>
    ...
    var ptotal = offer_price*Quantity;
   ...
   var ProductName = document.getElementById('typeahead').value
           ...
           document.getElementById('Product_Id').value =temp.Product.ProductID;
            document.getElementById('offer_price').value =temp.Product.offer_price;
      ...
      //alert(VBillingDet_Name); 
           ...
           document.getElementById('VBillingDet_Phone').value =temp.vendor.Phone;
...
var Name = document.getElementById('VBillingDet_Name').value




    xhr = new XMLHttpRequest();
    xhr.open('POST' , 'Getdetails.php' , true);
