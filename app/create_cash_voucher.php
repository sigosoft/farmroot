...
$query="INSERT INTO cash_voucher (Name, Phone, Address, Description, Amount, CVDate) VALUES ('$Name', '$Phone', '$Address', '$Description', '$Amount', '$CVDate')";

if (mysqli_query($conn, $query))
 {
    echo "<script> alert('Cash Voucher Added Successfully');window.location.href = 'manage_cash_vouchers.php';</script>";
 } 
...
die;
    ...
    echo "<script> alert('Error');window.location.href = 'create_cash_voucher.php';</script>";
}
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" method="POST" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="Phone" class="form-control col-md-7 col-xs-12" name="Phone" placeholder="Phone" required="required" type="number">
                        </div>
                      </div>
