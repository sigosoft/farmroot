...
$query="SELECT category.*,subcategory.* FROM category INNER JOIN subcategory ON subcategory.category_id=category.category_id where subcategory.category_id='$cat'";
